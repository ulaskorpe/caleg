...
<div class="col-2 text-center justify-content-center mt-5">
    <button class="btn btn-outline-success me-2 mb-2 mb-md-5" id="addBtn" onclick="create_setting()">{{ __('Add New setting') }}</button>
    <button class="btn btn-outline-success me-2 mb-2 mb-md-5" style="display: none" id="back2Btn" onclick="show_data(0)">{{ __('Back To Settings ') }}</button>
...
return false;
 ...
 var formData = new FormData(document.getElementById('setting-form'));
  ...
  save(formData, '/admin/settings/web-settings/create-setting', '', '',"{{route('admin.general.settings')}}");
