                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-10">
                                        <h6 class="card-title">{{__('Category List')}}</h6>
                                    </div>
                                    <div class="col-2 text-center justify-content-center">
                                        <a class="btn btn-outline-success me-2 mb-2 mb-md-5" href="{{route('admin.categories.create')}}">{{__('Add New Category')}}</a>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            deleteCategory = function(category){
                let url = "{{ route('admin.categories.destroy', ":category") }}";
