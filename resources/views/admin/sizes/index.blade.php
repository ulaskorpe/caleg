        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <nav class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">{{__('Sizes')}}</a></li>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-10">
                                        <h6 class="card-title">{{__('Sizes List')}}</h6>
                                    </div>
                                    <div class="col-2 text-center justify-content-center">
                                        <a class="btn btn-outline-success me-2 mb-2 mb-md-5" href="{{route('admin.sizes.create')}}">{{__('Add New Size')}}</a>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#sztable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{route('admin.sizes.datatables')}}',
                columns: [
                            { data: 'name', name: 'name' },
    ...
    <script type="text/javascript">
        $(function() {
            deleteSize = function(size){
                let url = "{{ route('admin.sizes.destroy', ":size") }}";
