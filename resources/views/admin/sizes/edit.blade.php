        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Edit Size')}}</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">{{__('Edit Size')}}</h6>
                            <form class="forms-sample" action="{{route('admin.size.update',$size->id)}}" method="POST" enctype="multipart/form-data" id="szform">
                                @csrf
                                <div class="row mb-3 mt-5 border justify-content-center" style="border-radius: 25px; border-color: lightgray !important; padding: 2%;">
                                            ...
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    <div class="col-md-6 mt-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-10">
                                                                <input class="form-control mb-4 mb-md-0 col-6" name="name" placeholder="{{__('Enter Size Name')}}" value="{{$size->name}}" autofocus required/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-10">
                                                                <input class="form-control mb-4 mb-md-0 col-6" name="price" placeholder="{{__('Size Price')}}" value="{{$size->price}}" autofocus required/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>                                                  
                                    ...
                                    <div class="text-center mt-5">
                                        <button class="btn btn-outline-primary submit" type="submit">{{__('Edit Size')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
