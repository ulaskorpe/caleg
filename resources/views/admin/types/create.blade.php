            ...
            <div class="page-content">
                ...
                <nav class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('New Type') }}</li>
                    </ol>
                </nav>
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">{{ __('Create New Type') }}</h6>
                                <form class="forms-sample" action="{{ route('admin.types.store') }}" method="POST"
                                    ...
                                    <div class="row mb-3 mt-5 border justify-content-center"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-10">
                                                                    <input class="form-control mb-4 mb-md-0 col-6"
                                                                        name="type"
                                                                        placeholder="{{ __('Enter Type Name') }}" autofocus
                                                                        required />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 mt-3">
                                                            <label class="form-label">{{ __('Type Price') }} (₺)*</label>
                                                            <div class="row">
                                                                <div class="col-10">
                                                                    <input type="number"
                                                                        class="form-control mb-4 mb-md-0 col-6"
                                                                        name="price"
                                                                        placeholder="{{ __('Enter Type Price (1, 1.4, etc.)') }}"
                                                                        autofocus required />
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="text-center mt-5">
                                            <button class="btn btn-outline-primary submit"
                                                type="submit">{{ __('Create New Type') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
