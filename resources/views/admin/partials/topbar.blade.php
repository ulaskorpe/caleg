<nav class="navbar">
    ...
    <div class="navbar-content">
        ...
        {{--  <li class="py-2">
            <a href="{{route('admin.clearcache')}}" class="btn btn-warning"> {{__('general.Clear System Cache')}} </a>
        </li>  --}}
        <ul class="navbar-nav">
            ...
            <div class="input-group form-check form-switch mt-2 py-2">
                <input type="checkbox" style="cursor: pointer" class="form-check-input" onclick="changeTheme()" {{Session::get('theme') == 'dark' ||  Session::get('theme') == 'auto' ? 'checked' : ''}}>
                {{Session::get('theme') == 'auto' ? 'auto' : ''}}
            </div>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            {{--  <img class="wd-80 ht-80 rounded-circle" src="{{asset('assets/admin/images/ni')}}" alt="">  --}}
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                            <a href="{{route('admin.profile.settings')}}" class="text-body ms-0">
                                <i class="me-2 icon-md" data-feather="settings"></i>
                                <span>{{__('general.Account Settings')}}</span>
                            </a>
                        </li>
                        <li class="dropdown-item py-2">
