            ...
            <div class="footer-item" data-aos="fade-up" data-aos-duration="1200">
                ...
                <div class="flex-align gap-8 my-32">
                    <a href="https://www.apple.com/store" class="">
                        <img src="assets/images/site_data/{{$data['footer-logo-1']}}" alt="">
                    </a>
                    <a href="https://play.google.com/store/apps?hl=en" class="">
                        <img src="assets/images/site_data/{{$data['footer-logo-2']}}" alt="">
                    </a>
                </div>
    ...
    <div class="container container-lg">
        <div class="bottom-footer__inner flex-between flex-wrap gap-16 py-16">
            ...
            <div class="flex-align gap-8 flex-wrap" data-aos="fade-left" data-aos-duration="800">
                ...
                <img src="assets/images/site_data/{{$data['payment-logo']}}" alt="">
            </div>
        </div>
    </div>
</div>
