...
<div class="newsletter" style="margin-top: 50px" >
    <div class="container container-lg"  >
        <div class="newsletter-box position-relative rounded-16   flex-wrap z-1">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-8">
                        ...
                        <h1 class="text-white mb-12" data-aos="fade-down" data-aos-duration="800">{{$data['newsletter-top']}}</h1>
                        <p class="text-white h5 mb-0" data-aos="fade-up" data-aos-duration="800">{{$data['newsletter-txt']}}</p>
                ...
                <div class="col-xl-4 text-center d-xl-block d-none">
                    <img src="{{url('assets/images/site_data/'.$data['newsletter-banner'])}}" style="max-height: 400px" alt="" data-aos="zoom-in" data-aos-duration="800">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="newsletter-box position-relative rounded-16 flex-align gap-16 flex-wrap z-1">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 text-center d-xl-block d-none">
                        <img src="{{url('assets/images/site_data/'.$data['newsletter-banner'])}}" style="max-height: 300px" alt="" data-aos="zoom-in" data-aos-duration="800">
                    </div>
                </div>
            </div>
        </div>
