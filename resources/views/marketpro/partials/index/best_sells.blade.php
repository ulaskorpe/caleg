<div class="row g-12" style="height: 30px">&nbsp;</div>
        <!-- ========================= best sells Start ================================ -->
...
<div class="col-md-4" data-aos="fade-up" data-aos-duration="{{$t}}">
...
<div class="">
<span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white">indirim 50% </span>
...
<div class="product-card__price mb-16">
    <span class="text-gray-400 text-md fw-semibold text-decoration-line-through"> {{$product['price']*2}} TL</span>
    <span class="text-heading text-md fw-semibold ">{{$product['price']}} <span class="text-gray-500 fw-normal"></span> </span>
</div>
