...
class UserController extends Controller
{
    ...
    public function forget_password(){
        ...
        return view('marketpro.front.forget_pw',['action'=>'forget_pw',
            'todo'=>'Şifremi Unuttum'
        ,'img'=>$data['img'],'text'=>$data['text']]);
        }
    }
    ...
    public function login(){
        ...
        return view('marketpro.front.login',['action'=>'user_login',
    ...
    public function register(){
        ...
        if(!empty(Session::get('user_code'))){
            ...
            $data  =  $this->service->generateImage();
            return view('marketpro.front.register',['action'=>'register'
    ...
    public function register_user(Request $request){
        ...
        //    return Str::random(20).rand(1000,5000);
           ...
           $user = User::create([
              ...
              //  'phone_number'=>(!empty($request->phone_number))?$request->phone_number:'',
                ...
                'OTP' => Str::random(20).rand(1000,5000),
    ...
    public function login_user(Request $request){
        ...
        $user = User::where('email', $request['email_login'])->first();
           if(empty($user)){
            return  $this->error([],"Böyle Bir kullanıcı yok".$request['email_login'] ,200);
           }
       // $user = User::where('admin_code',$request->admin_code)->first();

       if ($user && Hash::check($request['password_login'], hashedValue: $user->password)) {
        Auth::attempt(['email' =>(string)$user['email_login'], 'password' =>(string)$request->password_login]);
        Auth::login($user);
    ...
    public function confirm_user($token=''){
        ...
        return view('marketpro.front.confirm',['msg'=>$msg]);
    }
    ...
    public function email_exists($email){
        ...
        $err = "Geçersiz eposta adresi";
            ...
            $err = (!empty($user))?"ok":"Bu eposta ile kayıtlı kullanıcı yok";
        }
