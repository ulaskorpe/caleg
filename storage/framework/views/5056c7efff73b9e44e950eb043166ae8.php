                ...
                <div class="banner-slider__item">   
                    <div class="banner-slider__inner flex-between position-relative">
                        <div class="banner-item__content">
                            <h1 class="banner-item__title wow bounceInDown"  data-wow-duration="1s"><?php echo e($slider['title']); ?></h1>
                        ...
                        <div class="banner-item__thumb wow bounceIn" data-wow-duration="1s" data-tilt data-tilt-max="12" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-scale="1.06">
                            <img src="assets/images/slider/<?php echo e($slider['image']); ?>" alt="" style="width:597px;height:354px">
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH /home/vagrant/code/caleg/resources/views/marketpro/partials/index/banner_slider.blade.php ENDPATH**/ ?>