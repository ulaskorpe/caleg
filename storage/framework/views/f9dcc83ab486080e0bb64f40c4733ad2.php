...
<!-- =============================== Account Section Start =========================== -->
 ...
 <div class="col-md-6">
   ...
   <form class="form" id="forget-form" name="forget-form" action='<?php echo e(route('login_user')); ?>'
...
<div class="mb-24 mt-48">
   ...
   <div class="mt-48">
       <a href="<?php echo e(route('user-login')); ?>" class="text-danger-600 text-sm fw-semibold hover-text-decoration-underline">Üye Giriş</a>
   </div>
</div>
</div>
</form>
...
<?php echo $__env->make('marketpro.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/caleg/resources/views/marketpro/front/forget_pw.blade.php ENDPATH**/ ?>